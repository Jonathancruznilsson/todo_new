...
const firstcheck = new Checklist("Vakna");
const secondcheck = new Checklist("Äta frukost");
const thirdcheck = new Checklist("Handla");
const fourthcheck = new Checklist("Laga mat");
const fifthcheck = new Checklist("Äta maten");
